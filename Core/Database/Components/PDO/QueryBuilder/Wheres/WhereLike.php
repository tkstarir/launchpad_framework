...
namespace TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Wheres {
	...
	if(!trait_exists('\TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Wheres\WhereLike')){
		trait WhereLike {
			...
			public static function WhereLike(String $column = '', String $value = null, Callable $closure = null) : \TkStar\LaunchPad\Web\Database {
			...
			// @param Callable $closure | default null
			// return \TkStar\LaunchPad\Web\Database
			public static function AndWhereLike(String $column = '', String $value = null, Callable $closure = null) : \TkStar\LaunchPad\Web\Database {
				return(self::WhereLike($column, $value, $closure));
			}
		}
	}
	return(\TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Wheres\WhereLike::class);
}
?>