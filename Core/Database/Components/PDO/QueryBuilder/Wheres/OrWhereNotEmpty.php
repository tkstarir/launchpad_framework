...
namespace TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Wheres {
	...
	if(!trait_exists('\TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Wheres\OrWhereNotEmpty')){
		trait OrWhereNotEmpty {
			// Define or Where not Empty for a Column
			// @param String $column | default Empty
			// @param Callable $closure | default null
			// return \TkStar\LaunchPad\Web\Database
			public static function OrWhereNotEmpty(String $column = '', Callable $closure = null) : \TkStar\LaunchPad\Web\Database {
	...
	return(\TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Wheres\OrWhereNotEmpty::class);
}
?>