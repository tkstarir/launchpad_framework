...
namespace TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Wheres {
	...
	if(!trait_exists('\TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Wheres\OrWhereEmpty')){
		trait OrWhereEmpty {
			...
			public static function OrWhereEmpty(String $column = '', Callable $closure = null) : \TkStar\LaunchPad\Web\Database {
	...
	return(\TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Wheres\OrWhereEmpty::class);
}
?>