...
namespace TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Wheres {
	...
	if(!trait_exists('\TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Wheres\OrWhereNull')){
		trait OrWhereNull {
			...
			public static function OrWhereNull(String $column = '', Callable $closure = null) : \TkStar\LaunchPad\Web\Database {
	...
	return(\TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Wheres\OrWhereNull::class);
}
?>