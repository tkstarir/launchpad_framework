...
namespace TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Ins {
	...
	if(!trait_exists('\TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Ins\OrIn')){
		trait OrIn {
			...
			public static function OrIn(String $column = '', $in = '', Callable $closure = null) : \TkStar\LaunchPad\Web\Database {
	...
	return(\TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Ins\OrIn::class);
}
?>