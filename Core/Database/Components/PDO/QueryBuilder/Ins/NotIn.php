...
namespace TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Ins {
	...
	if(!trait_exists('\TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Ins\NotIn')){
		trait NotIn {
			...
			public static function NotIn(String $column = '', $in = '', Callable $closure = null) : \TkStar\LaunchPad\Web\Database {
			...
			// @param Callable $closure | default null
			// return \TkStar\LaunchPad\Web\Database
			public static function AndNotIn(String $column = '', $in = '', Callable $closure = null) : \TkStar\LaunchPad\Web\Database {
				return(self::NotIn($column, $in, $closure));
			}
		}
	}
	return(\TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Ins\NotIn::class);
}
?>