...
namespace TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Utils {
	...
	if(!trait_exists('\TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Utils\First')){
		trait First {
	...
	return(\TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Utils\First::class);
}
?>