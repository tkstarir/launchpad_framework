...
namespace TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Utils {
	...
	if(!trait_exists('\TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Utils\Middle')){
		trait Middle {
	...
	return(\TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Utils\Middle::class);
}
?>