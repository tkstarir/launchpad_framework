...
namespace TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Joins {
	...
	if(!trait_exists('\TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Joins\Join')){
		trait Join {
			// Join Method for Join 2 Table with Them Columns
			...
			public static function Join(String $second_table = '', String $left_column = '', String $operator = '', String $right_column, Callable $closure = null) : \TkStar\LaunchPad\Web\Database {
			...
			// @param Callable $closure | default null
			// return \TkStar\LaunchPad\Web\Database
			public static function InnerJoin(String $second_table = '', String $left_column = '', String $operator = '', String $right_column, Callable $closure = null) : \TkStar\LaunchPad\Web\Database {
				return(self::InnerJoin($second_table, $left_column, $operator, $right_column, $closure));
			}
		}
	}
	return(\TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Joins\InnerJoin::class);
}
?>