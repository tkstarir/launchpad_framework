...
namespace TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Joins {
	...
	if(!trait_exists('\TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Joins\LeftJoin')){
		trait LeftJoin {
			...
			public static function LeftJoin(String $second_table = '', String $left_column = '', String $operator = '', String $right_column, Callable $closure = null) : \TkStar\LaunchPad\Web\Database {
	...
	return(\TkStar\LaunchPad\Web\Components\Database\PDO\QueryBuilder\Joins\LeftJoin::class);
}
?>